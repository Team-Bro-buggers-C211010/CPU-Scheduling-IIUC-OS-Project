...
function showFinalTable(input, output, outputDiv) {
    ...
    finalTableHeading.innerHTML = "<br><strong>Final Table</strong>";
    ...
    let cpu = document.createElement("h2");
    cpu.innerHTML = "<br><strong>CPU Utilization : " + (tbt / lastct) * 100 + "%</strong>";
